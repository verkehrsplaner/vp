...
public class LinienGUI extends JFrame {
    ...
    public LinienGUI(Linie l, Spielsteuerung s) {
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                bilanz.setText(formatGeld.format(linie.getGewinn()));
    ...
    private void initComponents() {
        ...
        jButtonBahnhof.setBounds(353, 264, 115, 74);
        ...
        jButtonBahnhofWeg.setBounds(488, 264, 115, 74);
        ...
        jButtonLöschen.setBounds(312, 410, 290, 74);
        ...
        jButtonFarbe.setBounds(10, 410, 290, 74);
        ...
        kapazitaet.setBounds(10, 204, 73, 16);
        ...
        auslastung.setBounds(10, 274, 73, 16);
        ...
        gesamtLaenge.setBounds(254, 363, 41, 16);
        ...
        jButton1.setBounds(353, 350, 250, 26);
    ...
    /**
     * Zuerst wird ein neues Feld erstellt, in denen die Buttontexte festgelegt
     * werden. Danach wird dem Benutzer ein JOptionPane angezeigt, in welchem er
     * gefragt wird, ob die Linien gelöscht werden soll. Wenn "Ja" geklickt wird
     * (0), wird die Linie aus der Spielsteuerung gelöscht und das Linien
     * Fenster geschlossen.
     *
    ...
    /**
     * Dem Integer wird der ausgewählte Eintrag zugewiesen. Nun kann man in
     * einem OptionPane der Liste einen weiteren Bahnhof hinzufügen
     *
     * @param evt Neues ungenutztes Event
     */
    ...
    /**
     * In einem Java Color Chooser kann eine neue Farbe für die Linie ausgewählt
     * werden
     *
     * @param evt
     */
    ...
    /**
     * Die Linie wird freigegeben oder und in der Klasse Linie wird
     * setGruenesLicht auf true oder false gesetzt
     *
     * @param evt
     */
